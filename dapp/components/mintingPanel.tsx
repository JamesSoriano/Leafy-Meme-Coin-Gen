...
function Minting() {
  ...
  return (
    <div
      className="flex grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:text-left rounded-lg p-4 bg-gradient-to-b from-yellow-300 to-green-900 h-96"
      style={{
        position: "absolute",
        top: "50%",
        left: "50%",
